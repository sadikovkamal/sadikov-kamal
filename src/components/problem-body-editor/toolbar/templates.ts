...
export const FORMULA_GROUPS: FormulaGroup[] = [
  ...
  // ── 2. Scripts (subscripts & superscripts) ────────────────────────────────
  {
    ...
    templates: [
      ...
      { icon: "ⁿx", label: "Old yuqori indeks", latex: "{}^{#0}#1", target: "inline" },
      { icon: "ₙx", label: "Old pastki indeks", latex: "{}_{#0}#1", target: "inline" },
      { icon: "x̄", label: "Ustki belgi (overset)", latex: "\\overset{#0}{#1}", target: "inline" },
      { icon: "x̲", label: "Pastki belgi (underset)", latex: "\\underset{#0}{#1}", target: "inline" },
      { icon: "x̲̄", label: "Ustki va pastki belgi", latex: "\\overset{#0}{\\underset{#1}{#2}}", target: "inline" },
    ],
  },
    ...
    sections: [
      {
        ...
        templates: [
          ...
          { icon: "⟨ |", label: "Bra (Dirak)", latex: "\\left\\langle #0 \\right|", target: "inline" },
          { icon: "| ⟩", label: "Ket (Dirak)", latex: "\\left| #0 \\right\\rangle", target: "inline" },
          { icon: "⟦ ⟧", label: "Qo'sh kvadrat (Iverson)", latex: "[\\![ #0 ]\\!]", target: "inline" },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        templates: [
          ...
          { icon: "x⃜", label: "To'rt nuqta", latex: "\\ddddot{#0}", target: "inline" },
      ...
      },
      {
        ...
        templates: [
          ...
          { icon: "⌒", label: "Ustki yoy", latex: "\\overgroup{#0}", target: "inline" },
          { icon: "⌣", label: "Pastki yoy", latex: "\\undergroup{#0}", target: "inline" },
        ],
      },
      {
        label: "Chizib tashlash",
        templates: [
          { icon: "/", label: "Chizib tashlash", latex: "\\cancel{#0}", target: "inline" },
          { icon: "\\", label: "Teskari chizish", latex: "\\bcancel{#0}", target: "inline" },
          { icon: "✕", label: "X chizish", latex: "\\xcancel{#0}", target: "inline" },
          { icon: "↗0", label: "Qiymatga chizish", latex: "\\cancelto{#1}{#0}", target: "inline" },
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        templates: [
          ...
          { icon: "ᵃ→ᵦ", label: "Ustki va pastki yorliqli o'q", latex: "\\xrightarrow[#0]{#1}", target: "inline" },
          { icon: "⇌□", label: "Yorliqli muvozanat", latex: "\\xrightleftharpoons{#0}", target: "inline" },
          { icon: "↦□", label: "Yorliqli akslantirish", latex: "\\xmapsto{#0}", target: "inline" },
          { icon: "↪□", label: "Yorliqli o'ng ilmoq", latex: "\\xhookrightarrow{#0}", target: "inline" },
          { icon: "↩□", label: "Yorliqli chap ilmoq", latex: "\\xhookleftarrow{#0}", target: "inline" },
          { icon: "↠□", label: "Ikki boshli o'ng o'q", latex: "\\xtwoheadrightarrow{#0}", target: "inline" },
          { icon: "↞□", label: "Ikki boshli chap o'q", latex: "\\xtwoheadleftarrow{#0}", target: "inline" },
          { icon: "=□", label: "Yorliqli tenglik", latex: "\\xlongequal{#0}", target: "inline" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        templates: [
          ...
          { icon: "1×4", label: "1×4 satr-vektor", latex: "\\begin{matrix}#0 & #1 & #2 & #3\\end{matrix}", target: "display" },
          { icon: "4×1", label: "4×1 ustun-vektor", latex: "\\begin{matrix}#0 \\\\ #1 \\\\ #2 \\\\ #3\\end{matrix}", target: "display" },
        ],
      },
      {
        label: "Nuqtalar",
  ...
  // ── Relations ─────────────────────────────────────────────────────────────
  {
    ...
    templates: [
      ...
      sym("◁", "Chap uchburchak", "\\triangleleft"),
      sym("▷", "O'ng uchburchak", "\\triangleright"),
      sym("⊴", "Chap uchburchak yoki teng", "\\trianglelefteq"),
      sym("⊵", "O'ng uchburchak yoki teng", "\\trianglerighteq"),
    ],
  },
  ...
  // ── Binary operators ──────────────────────────────────────────────────────
  {
    ...
    templates: [
      ...
      sym("⨿", "Amalgama (ko-ko'paytma)", "\\amalg"),
      sym("≀", "To'lqinli ko'paytma", "\\wr"),
      sym("⊓", "Pastki to'r", "\\sqcap"),
      sym("⊔", "Yuqori to'r", "\\sqcup"),
    ],
  },
  ...
  // ── Arrows ────────────────────────────────────────────────────────────────
  {
    ...
    templates: [
      ...
      sym("⇋", "Teskari muvozanat", "\\leftrightharpoons"),
      sym("⇕", "Yuqori-past qo'sh", "\\Updownarrow"),
      sym("⇄", "O'ng-chap o'qlar", "\\rightleftarrows"),
      sym("⇆", "Chap-o'ng o'qlar", "\\leftrightarrows"),
      sym("⇉", "Ikki o'ng o'q", "\\rightrightarrows"),
      sym("⇇", "Ikki chap o'q", "\\leftleftarrows"),
      sym("↑↑", "Ikki yuqori o'q", "\\upuparrows"),
      sym("↓↓", "Ikki pastki o'q", "\\downdownarrows"),
      sym("↠", "Ikki boshli o'ng", "\\twoheadrightarrow"),
      sym("↞", "Ikki boshli chap", "\\twoheadleftarrow"),
    ],
  },
  ...
  // ── Special symbols ───────────────────────────────────────────────────────
  {
    ...
    templates: [
      ...
      sym("∤", "Bo'linmaydi", "\\nmid"),
      sym("%", "Foiz", "\\%"),
      sym("℧", "Mho (teskari om)", "\\mho"),
      sym("◇", "Romb (lozenge)", "\\lozenge"),
      sym("∢", "Sferik burchak", "\\sphericalangle"),
      sym("○", "Katta doira", "\\bigcirc"),
      sym("▽", "Teskari uchburchak", "\\triangledown"),
      sym("ℵ", "Alef", "\\aleph"),
      sym("ℶ", "Bet", "\\beth"),
      sym("∎", "Isbot oxiri (QED)", "\\blacksquare"),
    ],
  },
